...
To preprocess handwritten digit images for model training

To train a model capable of recognizing digits (0–9)
...
Evaluate performance using accuracy and predictions
...
Add real-time digit input using a GUI
